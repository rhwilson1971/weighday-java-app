package net.cynreub.weighday.data.local;
...
import net.cynreub.weighday.util.DateConverter;

import java.util.concurrent.ExecutorService;
import java.util.concurrent.Executors;

@Database(entities = {WeightEntryEntity.class, WeightGoalEntity.class}, version = 1, exportSchema = false)
            ...
            synchronized (AppDatabase.class) {
                if (INSTANCE == null) {
                    INSTANCE = Room.databaseBuilder(context.getApplicationContext(),
                                    AppDatabase.class, "weighday_database")
                            .build();
                }
            }
        }
